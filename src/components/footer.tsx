...
const socialLinks = [
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/blockplay",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@blockplay",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@blockplay",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
...
const footerLinks = {
  ...
  Community: [
    { label: "X / Twitter", href: "https://x.com/blockplay" },
    { label: "Instagram", href: "https://instagram.com/blockplay" },
    { label: "TikTok", href: "https://tiktok.com/@blockplay" },
    { label: "YouTube", href: "https://youtube.com/@blockplay" },
  ],
}
